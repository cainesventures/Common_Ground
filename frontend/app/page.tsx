  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Headline */}
        <Link href={`/legislation/${bill.id}?tab=perspectives`}>
    ...
    <div className="space-y-20 pb-20">
      ...
      {spotlight.length > 0 && (
        <section className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/legislation?analyzed=true&perspectives=true" className="text-sm text-primary hover:underline">
              Browse all bills →
            </Link>
          </div>
      ...
      {recentBills.length > 0 && (
        <section className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/legislation?analyzed=true" className="text-sm text-primary hover:underline">
              See all →
            </Link>
          </div>
          <div className="flex flex-col gap-3 anim-fade-in">
            {recentBills.map((bill) => (
              <BillCard key={bill.id} bill={bill} showDate={true} />
            ))}
          </div>
        </section>
      )}
      ...
      <section className="max-w-2xl mx-auto text-center">
        ...
        <p className="type-body-sm text-muted-foreground mb-8">
          Common Ground is a free, independent civic tool with no ads, no corporate backing, and no political agenda. We just want Philly residents to know what their council is doing.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <Link
            href="/api/auth/login"
