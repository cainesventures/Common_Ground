...
CANONICAL = {
    ...
    "infrastructure":       ["infrastructure", "city infrastructure", "utilities", "utility",
                             ...
                             "street-regulation", "street-regulations", "street-paving",
                             "paving", "street-vacation", "street-designation",
                             "public-infrastructure", "condemnation"],
    "land-use":             ["land use", "land-use", "land_use", "land use planning",
                             ...
                             "vacant-properties", "land-transfer", "property-sale",
                             "acquisition", "residential-districts", "local-development",
                             "industrial-development"],
    "planning":             ["planning", "city planning", "urban planning", "urban development",
                             "urban renewal", "urban-renewal", "city-planning", "urban_planning",
    ...
    "finance":              ["finance", "budget", "budgeting", "fiscal", "fiscal policy",
                             ...
                             "government-spending", "capital-spending", "government-finance",
                             "city-finances", "city-assets"],
    ...
    "business":             ["business", "businesses", "commerce", "commercial",
                             "business regulation", "business-regulations", "business development",
                             ...
                             "sidewalk café", "sidewalk sales", "sidewalk-sales", "newsstands",
                             "advertising", "signs", "consumer-protection",
                             "banks", "financial-services", "paid"],
    ...
    "public-safety":        ["public safety", "public_safety", "public-safety", "safety",
                             "law enforcement", "law-enforcement", "police", "police reform",
                             "crime", "crime prevention", "emergency services", "fire",
                             "criminal-justice", "firearms-safety"],
    ...
    "environment":          ["environment", "environmental", "environmental policy",
                             ...
                             "recycling", "waste management", "farming", "bicycling",
                             "bicycles", "drainage", "stormwater", "green", "climate",
    ...
    "government":           ["government", "city government", "city-government",
                             ...
                             "local-regulation", "government-transparency",
    ...
    "neighborhood":         ["neighborhood", "neighborhoods", "north philadelphia",
                             ...
                             "fairmount-park", "public-art", "farmers-market"],
    ...
    "ethics":               ["ethics", "campaign finance", "residency"],
    "leasing":              ["leasing", "leases", "lease"],
    "telecommunications":   ["telecommunications", "telecom", "broadband", "internet",
                             "cable", "wireless", "philadelphia-gas-works", "gas",
                             "water-department", "utilities-department"],
    "firearms":             ["firearms", "gun-control", "guns", "weapons", "second-amendment"],
    "sports":               ["sports", "stadiums", "stadium", "arena", "gaming",
                             "casinos", "casino", "recreation-facilities"],
    "civil-service":        ["civil-service", "city-employment", "payroll",
                             "city-administration", "city-management", "city-governance",
                             "city-services", "government-services", "public-services",
                             "services", "enforcement", "penalties"],
}
